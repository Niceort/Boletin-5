...
class NormalizadorColumnas:
    ...
    def _crear_alias(self):
        ...
        alias["partidos_jugados"] = ["pj", "partidos", "partidos jugados", "matches", "j"]
        alias["partidos_titular"] = ["pt", "titular", "partidos titular", "partidos de titular"]
        alias["partidos_suplente"] = ["ps", "suplente", "partidos suplente", "partidos de suplente"]
        alias["partidos_completos"] = ["pc", "partidos completos", "partidos enteros", "partidos completos jugados"]
        alias["minutos"] = ["min", "minutos", "minutes"]
        alias["goles"] = ["g", "goles", "goals"]
        alias["amarillas"] = ["ta", "amarillas", "tarjetas amarillas"]
